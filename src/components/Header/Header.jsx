...
const Header = () => {
    return (
        <div className="md:mt-16 mt-20 max-w-6xl mx-auto grid md:grid-cols-2 gap-5">
            <div className="flex items-center">
                <div className="md:text-right text-center">
                    <div className="flex justify-center">
                        <img className="w-64 hidden md:block" src="https://i.ibb.co/rQKZp5m/mockup-graphics-n-Xjv-Ul-E8418-unsplash-removebg-preview.png" alt="" />
                    </div>
                    <h1 className="md:text-6xl text-3xl font-bold mb-3">Hi, from BiteBliss</h1>
